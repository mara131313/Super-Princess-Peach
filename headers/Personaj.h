...
public:
    Personaj() :
        viata(100), atac(50), viteza(50), x(1), y(1), isOnGround(false), velocity(0.f, 0.f) {
...
//
    ...
    viata(_viata), atac(_atac), viteza(viteza), x(_x), y(_y), isOnGround(false), velocity(0.f, 0.f) {
        shape.setSize(sf::Vector2f(40.f, 40.f));
        shape.setFillColor(sf::Color::Magenta);
